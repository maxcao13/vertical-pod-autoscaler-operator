...
# openshift.io/vertical-pod-autoscaler-operator-bundle:$VERSION and openshift.io/vertical-pod-autoscaler-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= openshift.io/vertical-pod-autoscaler-operator
...
.PHONY: deploy-bundle
deploy-bundle: operator-sdk ## Deploy the controller in the bundle format with OLM.
