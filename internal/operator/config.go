...
const (
	...
	// TODO(macao): come back to this if we need to revert to "openshift-vertical-pod-autoscaler"
	...
	DefaultVerticalPodAutoscalerNamespace = "openshift-vertical-pod-autoscaler" // TODO(macao): same as above
