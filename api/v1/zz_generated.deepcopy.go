...
func (in *AdmissionDeploymentOverride) DeepCopyInto(out *AdmissionDeploymentOverride) {
	*out = *in
	in.DeploymentOverride.DeepCopyInto(&out.DeploymentOverride)
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdmissionDeploymentOverride.
func (in *AdmissionDeploymentOverride) DeepCopy() *AdmissionDeploymentOverride {
	if in == nil {
		return nil
	}
	out := new(AdmissionDeploymentOverride)
	in.DeepCopyInto(out)
	return out
}
